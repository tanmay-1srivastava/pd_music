...
Analysis for Taraneh - July 24th Session
"""
...
def create_visual_comparison():
    ...
    print("Creating visual comparison plots for Taraneh...")
    
    # Load the latest results from inexpensive IMU
    with open('Results/individual_sessions/Taranneh_July_24_Session_1.json', 'r') as f:
    ...
    # Data from expensive sensors (from your table for Taraneh)
    expensive_data = {
        "Cadence (steps/min)": 115,  # Average of L&R (115|114)
        "Gait Speed (m/s)": 1.14,   # Average of L&R (1.14|1.14)
        "Step Duration (s)": 0.521,  # Average of L&R (0.521|0.530) 
        "Stride Length (m)": 1.20,   # Average of L&R (1.20|1.20)
        "Stride Time (s)": 1.05,     # Average of L&R (1.05|1.05)
        "Double Support (s)": 0.226  # Calculated from %GCT (21.4% of 1.05s)
    }
    ...
    plt.tight_layout()
    plt.savefig('Results/plots/Taraneh_Parameter_Comparison.png', dpi=300, bbox_inches='tight')
    plt.show()
    
    # Create a summary table
    print("\n" + "="*80)
    print("QUANTITATIVE COMPARISON SUMMARY - TARANEH")
    print("="*80)
    ...
    # Accuracy assessment
    print("\n" + "="*80)
    print("ACCURACY ASSESSMENT - TARANEH")
    print("="*80)
    ...
    comparison_df.to_csv('Results/summary/Taraneh_Parameter_Comparison.csv', index=False)
